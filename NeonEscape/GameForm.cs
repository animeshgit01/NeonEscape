...
namespace NeonEscape
{
    public partial class GameForm : Form
    {
        ...
        private void CheckCollision()
        {
            foreach (Enemy enemy in enemies)
            {
                if (enemy.Bounds.IntersectsWith(player))
                {
                    ...
                    enemy.Bounds.X =
                        random.Next(50, ClientSize.Width - 80);

                    enemy.Bounds.Y =
                        random.Next(100, ClientSize.Height - 80);
        ...
        private void RestartButton_Click(object sender, EventArgs e)
        {
            ...
            enemies.Add(
                new Enemy(100, 150, enemySpeed)
            );

            enemies.Add(
                new Enemy(700, 150, enemySpeed)
            );

            enemies.Add(
                new Enemy(100, 450, enemySpeed)
            );
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Pen gridPen =
                   new Pen(Color.FromArgb(25, 0, 255, 255), 1))
            {
                for (int x = 40;
